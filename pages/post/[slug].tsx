    ...
    return (
        <main>
            ...
            <article className='max-w-3xl mx-auto p-5'>
                ...
                <h2 className='text-xl font-light text-gray-500 mb-2'>{post.body[0]?.children[0]?.text}</h2>
            ...
            <hr className='max-w-lg my-5 mx-auto border-yellow-500' />
            {
                submitted ? (
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col p-5 max-w-2xl mx-auto mb-10'>
                        ...
                        <h4 className='text-3xl font-bold'>Leave a commant below!</h4>
                        ...
                        <label className='block mb-5'>
                            ...
                            <input
                                ...
                                type="text"
                                placeholder='Kumpon J Sotsukpiam'
                            />
                        </label>
                        <label className='block mb-5'>
                            ...
                            <input
                                ...
                                className='shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 focus:ring outline-none'
                                type="text"
                                placeholder='tetravaal.system@gmail.com'
                            />
                        </label>
                        <label className='block mb-5'>
                        ...
                        {/* errors will retunr when field validtion fails */}
                        ...
                        <input
                            className='shadow bg-yellow-500 text-white font-bold py-2 px-4 rounded cursor-pointer
...
export const getStaticPaths = async () => {
    ...
    const paths = posts.map((post: _Post) => ({
        params: {
